...
no_space(void)
{
    byacc_fprintf(stderr, "%s: f - out of space\n", myname);
    done(2);
}
...
{
    byacc_fprintf(stderr, "%s: f - cannot open \"%s\"\n", myname, filename);
    done(2);
}
...
missing_brace(void)
{
    byacc_fprintf(stderr, "%s: e - line %d of \"%s\", missing '}'\n",
...
unexpected_EOF(void)
{
    byacc_fprintf(stderr, "%s: e - line %d of \"%s\", unexpected end-of-file\n",
	    myname, lineno, input_file_name);
    done(1);
}
...
{
    byacc_fprintf(stderr, "%s: e - line %d of \"%s\", syntax error\n",
...
{
    byacc_fprintf(stderr, "%s: e - line %d of \"%s\", unmatched /*\n",
...
{
    byacc_fprintf(stderr, "%s: e - line %d of \"%s\", unterminated string\n",
...
{
    byacc_fprintf(stderr, "%s: e - line %d of \"%s\", unterminated %%union \
...
{
    byacc_fprintf(stderr, "%s: e - line %d of \"%s\", too many %%union \
declarations\n", myname, lineno, input_file_name);
...
{
    byacc_fprintf(stderr, "%s: e - line %d of \"%s\", illegal tag\n",
	    myname, t_lineno, input_file_name);
    print_pos(t_line, t_cptr);
    done(1);
}
...
{
    byacc_fprintf(stderr, "%s: e - line %d of \"%s\", illegal character\n",
	    myname, lineno, input_file_name);
...
{
    byacc_fprintf(stderr, "%s: w - line %d of \"%s\", the type of %s has been \
redeclared\n", myname, lineno, input_file_name, s);
}
...
{
    byacc_fprintf(stderr, "%s: w - line %d of \"%s\", the value of %s has been \
redeclared\n", myname, lineno, input_file_name, s);
}
...
{
    byacc_fprintf(stderr, "%s: e - line %d of \"%s\", the start symbol %s is a \
token\n", myname, lineno, input_file_name, s);
    done(1);
}
...
{
    byacc_fprintf(stderr, "%s: w - line %d of \"%s\", the start symbol has been \
redeclared\n", myname, lineno, input_file_name);
}
...
no_grammar(void)
{
    byacc_fprintf(stderr, "%s: e - line %d of \"%s\", no grammar has been \
specified\n", myname, lineno, input_file_name);
    done(1);
}
...
{
    byacc_fprintf(stderr, "%s: e - line %d of \"%s\", a token appears on the lhs \
of a production\n", myname, s_lineno, input_file_name);
    done(1);
}
...
{
    byacc_fprintf(stderr, "%s: w - line %d of  \"%s\", conflicting %%prec \
specifiers\n", myname, lineno, input_file_name);
}
...
{
    byacc_fprintf(stderr, "%s: e - line %d of \"%s\", unterminated action\n",
...
{
    byacc_fprintf(stderr, "%s: w - line %d of \"%s\", $%d references beyond the \
...
{
    byacc_fprintf(stderr, "%s: e - line %d of \"%s\", illegal $-name\n",
	    myname, a_lineno, input_file_name);
    print_pos(a_line, a_cptr);
    done(1);
}
...
untyped_lhs(void)
{
    byacc_fprintf(stderr, "%s: e - line %d of \"%s\", $$ is untyped\n",
	    myname, lineno, input_file_name);
    done(1);
}
...
{
    byacc_fprintf(stderr, "%s: e - line %d of \"%s\", $%d (%s) is untyped\n",
...
unknown_rhs(int i)
{
    byacc_fprintf(stderr, "%s: e - line %d of \"%s\", $%d is untyped\n",
...
{
    byacc_fprintf(stderr, "%s: e - the start symbol %s is undefined\n", myname, s);
    done(1);
}
...
{
    byacc_fprintf(stderr, "%s: w - the symbol %s is undefined\n", myname, s);
}
...
{
    byacc_fprintf(stderr, "%s: w - %s flag unsupported, %s\n",
	    myname, flag, details);
}
#endif
...
{
    byacc_fprintf(stderr, "%s: w - line %d of \"%s\", number of arguments of %s "
...
bad_formals(void)
{
    byacc_fprintf(stderr, "%s: e - line %d of \"%s\", bad formal argument list\n",
	    myname, lineno, input_file_name);
    print_pos(line, cptr);
    done(1);
}
...
{
    byacc_fprintf(stderr, "%s: w - line %d of \"%s\", type of argument %d "
...
{
    byacc_fprintf(stderr, "%s: w - line %d of \"%s\", unknown argument %s%s\n",
...
{
    byacc_fprintf(stderr, "%s: w - line %d of \"%s\", untyped argument %s%s\n",
...
{
    byacc_fprintf(stderr, "%s: w - line %d of \"%s\", destructor redeclared\n",
	    myname, a_lineno, input_file_name);
    print_pos(a_line, a_cptr);
}
#endif
